...
//    GpioCtrlRegs.GPFPUD.bit.GPIO160 = 1;
    ...
    ConfigCpuTimer(&CpuTimer1, 200, 250000);
...
//    init_serial(&SerialD,115200,serialRXD);
    ...
    //initialize the PWM register 9A
...
__interrupt void cpu_timer1_isr(void)
{
    ...
    if(state == 1){
        ...
        EPwm9Regs.TBPRD = Fa_H;
        state = 4;
    }

    else if(state == 4){
        EPwm9Regs.TBPRD = Mi_H;
        state = 5;
    }
