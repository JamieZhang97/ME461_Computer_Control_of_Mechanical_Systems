...
__interrupt void SPIB_isr(void){
    ...
    spivalue1 = SpibRegs.SPIRXBUF; // Read first 8 bit value off RX FIFO. Probably is zero since no chip
    spivalue2 = SpibRegs.SPIRXBUF; // Read second 8 bit value off RX FIFO. Again probably zero
