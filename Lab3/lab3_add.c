...
void main(void)
{
    ...
    EPwm5Regs.TBPRD = 1000; // Set Period to 1ms sample. Input clock is 50MHz.
...
float array[32]={   -1.6466950312719205e-03,
                    -1.9674478273332152e-03,
                    -2.5003674400324240e-03,
                    -2.9684278771570597e-03,
                    -2.8446917171801697e-03,
                    -1.4277801151067985e-03,
                    2.0225586357400412e-03,
                    8.1147975336387096e-03,
                    1.7155263118799242e-02,
                    2.9016348842214112e-02,
                    4.3076083572491840e-02,
                    5.8248706435185670e-02,
                    7.3107780287600024e-02,
                    8.6084070804293089e-02,
                    9.5704111083060386e-02,
                    1.0082568969505851e-01,
                    1.0082568969505851e-01,
                    9.5704111083060386e-02,
                    8.6084070804293089e-02,
                    7.3107780287600024e-02,
...
x[0] = (float)3.0*(adcd0result / 4095.0);
...
AdcbRegs.ADCSOC6CTL.bit.CHSEL = 0;
AdcbRegs.ADCSOC8CTL.bit.CHSEL = 0;
AdcbRegs.ADCSOCACTL.bit.CHSEL = 0;
AdcbRegs.ADCSOCCCTL.bit.CHSEL = 0;
AdcbRegs.ADCSOCECTL.bit.CHSEL = 0;

AdcbRegs.ADCSOC1CTL.bit.CHSEL = 1;
AdcbRegs.ADCSOC3CTL.bit.CHSEL = 1;
AdcbRegs.ADCSOC5CTL.bit.CHSEL = 1;
AdcbRegs.ADCSOC7CTL.bit.CHSEL = 1;
AdcbRegs.ADCSOC9CTL.bit.CHSEL = 1;
AdcbRegs.ADCSOCBCTL.bit.CHSEL = 1;
AdcbRegs.ADCSOCDCTL.bit.CHSEL = 1;
AdcbRegs.ADCSOCFCTL.bit.CHSEL = 1;
...
__interrupt void ADCD_ISR (void)
{
    ...
    uint32_t adcd0result = 0;
    uint32_t adcd1result = 1;
    uint32_t adcd0result = 2;
    uint32_t adcd1result = 3;
    uint32_t adcd0result = 4;
    uint32_t adcd1result = 5;
    uint32_t adcd0result = 6;
    uint32_t adcd1result = 7;
    uint32_t adcd0result = 8;
    uint32_t adcd1result = 9;
    uint32_t adcd0result = 10;
    uint32_t adcd1result = 11;
    uint32_t adcd0result = 12;
    uint32_t adcd1result = 13;
    uint32_t adcd0result = 14;
    uint32_t adcd1result = 15;

    adcd0result = AdcdResultRegs.ADCRESULT0;
    adcd1result = AdcdResultRegs.ADCRESULT1;
    adcd2result = AdcdResultRegs.ADCRESULT2;
    adcd3result = AdcdResultRegs.ADCRESULT3;
    adcd4result = AdcdResultRegs.ADCRESULT4;
    adcd5result = AdcdResultRegs.ADCRESULT5;
    adcd6result = AdcdResultRegs.ADCRESULT6;
    adcd7result = AdcdResultRegs.ADCRESULT7;
    adcd8result = AdcdResultRegs.ADCRESULT8;
    adcd9result = AdcdResultRegs.ADCRESULT9;
    adcd10result = AdcdResultRegs.ADCRESULT10;
    adcd11result = AdcdResultRegs.ADCRESULT11;
    adcd12result = AdcdResultRegs.ADCRESULT12;
    adcd13result = AdcdResultRegs.ADCRESULT13;
    adcd14result = AdcdResultRegs.ADCRESULT14;
    adcd15result = AdcdResultRegs.ADCRESULT15;

    avg0 = 0.125*adcd0result + 0.125*adcd2result + 0.125*adcd4result + 0.125*adcd6result + 0.125*adcd8result + 0.125*adcd10result + 0.125*adcd12result + 0.125*adcd14result;
    avg1 = 0.125*adcd1result + 0.125*adcd3result + 0.125*adcd5result + 0.125*adcd7result + 0.125*adcd9result + 0.125*adcd11result + 0.125*adcd13result + 0.125*adcd15result;
